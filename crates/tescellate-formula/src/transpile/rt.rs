...
//! shared `apply_*` / `bare_range` primitives, and — for function calls —
//! the `Expr` AST type and the `standard()` function registry. Keeping
//! this surface small and explicit is what lets a generated crate stay
//! trivial.

pub use crate::excellite::ast::{BinaryOp, Expr, UnaryOp};
pub use crate::excellite::eval::{apply_binary_op, apply_lambda, apply_unary_op, bare_range};
