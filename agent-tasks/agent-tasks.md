...
- [ ] T-101b (sprint 1): Save/SaveAs/Open commands + Ctrl+S/Ctrl+Shift+S/Ctrl+O keymap + NAV_KEYS + SHORTCUTS — touches: apps/tescellate-ui/src/keymap.rs, apps/tescellate-ui/src/app.rs
...
- [ ] T-102d (sprint 1): maybe_autosave per-frame tick — touches: apps/tescellate-ui/src/app.rs
- [ ] T-103 (sprint 1): Local CI gate — touches: (verification)
- [ ] T-104 (sprint 1): Open + merge PR webui-v145-save-open-autosave — touches: (git)
